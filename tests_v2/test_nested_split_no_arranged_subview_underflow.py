#!/usr/bin/env python3
"""Regression: nested splits must not transiently drop split-view arranged subviews below 2.
...
from the existing split view (arranged subview count < 2), which the toolkit can render
