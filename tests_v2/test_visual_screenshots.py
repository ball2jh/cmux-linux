...
def test_i23_browser_drag_split_right_webview_focused(client: cmux) -> StateChange:
    ...
    change = StateChange(
        ...
        description="Ensure WebView is first responder before dragging to split right.",
...
def _is_known_non_blocking_failure(change: StateChange) -> bool:
    """Return True for known flaky visual failures we still report but do not gate on."""
