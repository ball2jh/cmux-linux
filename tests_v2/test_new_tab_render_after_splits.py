...
Note: We use `panel_snapshot` instead of window screenshots to avoid permission issues.
"""
...
def main() -> int:
    with cmux(SOCKET_PATH) as c:
        ...
        # Focus signal can lag; proceed to snapshot-based validation either way.
        ...
        if change <= threshold:
            # Fallback: inject command directly to surface and re-check visual delta.
